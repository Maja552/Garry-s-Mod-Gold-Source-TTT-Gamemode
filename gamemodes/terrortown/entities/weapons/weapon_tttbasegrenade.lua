...
if CLIENT then
   SWEP.PrintName          = "incendiarygrenade_name"
...
SWEP.ViewModel             = "models/v_grenade_fire.mdl"
--SWEP.ViewModel             = "models/v_grenade_frost.mdl"
--SWEP.ViewModel             = "models/v_grenade_flare.mdl"
--SWEP.ViewModel             = "models/v_grenade_infect.mdl"
