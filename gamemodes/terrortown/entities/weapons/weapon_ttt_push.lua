...
SWEP.UseHands              = true
SWEP.ViewModel             = "models/hl1/c_egon.mdl"
SWEP.WorldModel            = "models/hl1/p_egon.mdl"
...
function SWEP:PrimaryAttack()
   ...
   self.Owner:SetVelocity(self.Owner:GetForward() * -280)
...
function SWEP:FirePulse(force_fwd, force_up)
   ...
   --local pvel = -(force_up * 1)
   --print("pvel: " .. pvel)
   --self.Owner:SetVelocity(self.Owner:GetForward() * pvel)
end
