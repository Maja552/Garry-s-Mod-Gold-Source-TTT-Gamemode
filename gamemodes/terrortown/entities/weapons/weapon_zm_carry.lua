...
if CLIENT then
   SWEP.PrintName           = "magnetostick_name"
   SWEP.Slot                = 4
...
SWEP.ViewModel              = Model("models/weapons/opfor/v_pipe_wrench.mdl")
SWEP.WorldModel             = Model("models/weapons/opfor/w_pipe_wrench.mdl")
