...
SWEP.Primary.Sound         = Sound( "Weapon_CS_AUG.Single" )
...
SWEP.UseHands              = true
SWEP.ViewModel             = Model("models/cs/v_aug.mdl")
SWEP.WorldModel            = Model("models/cs/p_aug.mdl")
