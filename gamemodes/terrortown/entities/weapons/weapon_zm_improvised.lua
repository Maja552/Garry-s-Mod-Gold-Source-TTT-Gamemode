...
SWEP.UseHands                = true
SWEP.ViewModel               = Model("models/hl1/c_crowbar.mdl")
...
local sound_single = Sound("hl1/weapons/cbar_miss1.wav")
local sound_open = Sound("DoorHandles.Unlocked3")

SWEP.MissSound = Sound("hl1/weapons/cbar_miss1.wav")

if SERVER then
   CreateConVar("ttt_crowbar_unlocks", "0", FCVAR_ARCHIVE)
...
SWEP.FleshyMaterials = {
   "HALFLIFE/FREEZER_MEAT"
}
...
function SWEP:PrimaryAttack()
   ...
   if IsValid(hitEnt) or tr_main.HitWorld then
      ...
      local player_or_body_or_npc = hitEnt:IsPlayer() or hitEnt:IsNPC() or hitEnt:GetClass() == "prop_ragdoll"

      --print(tr_main.HitTexture)

      if player_or_body_or_npc or table.HasValue(self.FleshyMaterials, tr_main.HitTexture) then
         self.Weapon:EmitSound("hl1/weapons/cbar_hitbod"..math.random(1,3)..".wav")
      else
         self.Weapon:EmitSound("hl1/weapons/cbar_hit"..math.random(1,2)..".wav")
      end
