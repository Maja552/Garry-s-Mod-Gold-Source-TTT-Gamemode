...
if CLIENT then
   SWEP.PrintName          = "xm1014_name"
   SWEP.Slot               = 2

   SWEP.ViewModelFlip      = true
   SWEP.ViewModelFOV       = 80

   SWEP.Icon               = "vgui/ttt/icon_xm1014"
   SWEP.IconLetter         = "B"
end
...
SWEP.Primary.Ammo          = "ammo_new_12g"
SWEP.Primary.Caliber       = "new_cs_12g"
...
SWEP.Primary.Sound         = Sound( "Weapon_CS_XM1014.Single" )
...
SWEP.UseHands              = true
SWEP.ViewModel             = "models/cs/v_xm1014.mdl"
SWEP.WorldModel            = "models/cs/p_xm1014.mdl"
...
function SWEP:PerformReload()
   ...
   self:EmitSound("cstrike/weapons/m3_insertshell.wav")
