...
ENT.Model = Model("models/cs/w_smokegrenade.mdl")
   ...
   function ENT:CreateSmoke(center)
      ...
      for i=1, 32 do
         ...
         if p then
            ...
            p:SetStartAlpha(255)
            p:SetEndAlpha(210)
            p:SetVelocity(VectorRand() * math.Rand(900, 1700))
            p:SetLifeTime(0)
            
            p:SetDieTime(math.Rand(50, 70))

            p:SetStartSize(math.random(140, 190))
...
function ENT:Explode(tr)
   if SERVER then
      ...
      self:EmitSound("cstrike/weapons/sg_explode.wav")
