...
local gunsounds = {
   shotgun = {
      sound = Sound( "Weapon_CS_XM1014.Single" ),
      delay = 0.8,
      times = {1, 3},
      burst = false
   },
   ...
   pistol = {
      sound = Sound( "Weapon_CS_FiveSeven.Single" ),
      delay = 0.2,
      times = {2, 4},
      burst = false
   },
   ...
   mac10 = {
      sound = Sound( "Weapon_CS_MAC10.Single" ),
      delay = 0.065,
      times = {5, 10},
      burst = true
   },
   ...
   deagle = {
      sound = Sound( "Weapon_CS_DEagle.Single" ),
      delay = 0.6,
      times = {1, 3},
      burst = false
   },
   ...
   m16 = {
      sound = Sound( "Weapon_CS_M4A1.Single" ),
      delay = 0.1,
      times = {5, 20},
      burst = true
   },
   ...
   rifle = {
      sound = Sound( "Weapon_CS_Scout.Single" ),
      delay = 1.5,
      times = {1, 1},
      burst = false,
      ampl = 80
   ...
   huge = {
      sound = Sound( "Weapon_CS_M249.Single" ),
      delay = 0.106,
      times = {6, 20},
      burst = true
   }
