...
local color_slot = {
   ...
   [ROLE_ZOMBIE]    = Color(124, 180, 50, 255)
}
...
local function TraitorMenuPopup()
   ...
   if ply:HasEquipmentItem(EQUIP_CLOAK) then
      local dcloak = CLOAK.CreateMenu(dsheet)
      dsheet:AddSheet(GetTranslation("cloak_name"), dcloak, "icon16/user.png", false, false, GetTranslation("equip_tooltip_cloak"))
   end
