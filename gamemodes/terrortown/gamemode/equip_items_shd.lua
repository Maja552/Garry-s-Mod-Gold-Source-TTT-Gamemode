...
--      },
   ...
   [ROLE_TRAITOR] = {
      ...
      -- boots - stealth
      {  id       = EQUIP_BOOTS_STEALTH,
         type     = "item_active",
         material = mat_dir .. "icon_boots_stealth",
         name     = "item_boots_stealth",
         desc     = "item_boots_stealth_desc"
      },

      -- boots - jump
      {  id       = EQUIP_BOOTS_JUMP,
         type     = "item_active",
         material = mat_dir .. "icon_boots_jump",
         name     = "item_boots_jump",
         desc     = "item_boots_jump_desc"
      },

      -- cloak
      {  id       = EQUIP_CLOAK,
         type     = "item_active",
         material = mat_dir .. "icon_cloak",
         name     = "item_cloak",
         desc     = "item_cloak_desc"
      }
   };
};

hook.Add("TTTOrderedEquipment", "GSTT_BoughtItem", function(ply, equipment, is_item)
   if is_item then
      if equipment == EQUIP_BOOTS_JUMP then
         ply:SetJumpPower(220)

         /*
      elseif equipment == EQUIP_CLOAK then
