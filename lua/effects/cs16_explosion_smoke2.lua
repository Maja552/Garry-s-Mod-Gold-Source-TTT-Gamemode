...
function EFFECT:Render()
	...
	self.g_sModelIndexSmoke:SetInt("$frame", math.Clamp(math.floor(self.Frame * 6), 0, 15))
	render.DrawSprite(self.Pos + Vector(0, 0, self.SmokeZ), 160 * 0.5, 160, Color(0, 0, 0, 255))
end